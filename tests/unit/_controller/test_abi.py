...
class TestAbi:
    ...
    @pytest.mark.parametrize(
        ...
        argvalues=[
            ...
            ("USER_CREATE_SESSION_OPTIMISTIC", 0x85),
            ("USER_CREATE_STREAM", 0x86),
            ("USER_EXPORT_KEYING_MATERIAL", 0x87),
            ("USER_GET_CONNECTION_DIAGNOSTICS", 0x88),
            ("USER_GET_SESSION_DIAGNOSTICS", 0x89),
            ("USER_GET_STREAM_DIAGNOSTICS", 0x8A),
            ("USER_READ_STREAM", 0x8B),
