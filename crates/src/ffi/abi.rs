...
pub(super) const NOTIFY_REQUEST_DONE: u8 = 0x44;
pub(super) const NOTIFY_REQUEST_FAILED: u8 = 0x45;
pub(super) const CONNECTION_CLOSE: u8 = 0x80;
pub(super) const USER_ACCEPT_SESSION: u8 = 0x81;
pub(super) const USER_CLOSE_SESSION: u8 = 0x82;
pub(super) const USER_CONNECTION_GRACEFUL_CLOSE: u8 = 0x83;
pub(super) const USER_CREATE_SESSION: u8 = 0x84;
pub(super) const USER_CREATE_STREAM: u8 = 0x85;
pub(super) const USER_GET_CONNECTION_DIAGNOSTICS: u8 = 0x86;
pub(super) const USER_GET_SESSION_DIAGNOSTICS: u8 = 0x87;
pub(super) const USER_GET_STREAM_DIAGNOSTICS: u8 = 0x88;
pub(super) const USER_GRANT_DATA_CREDIT: u8 = 0x89;
pub(super) const USER_GRANT_STREAMS_CREDIT: u8 = 0x8A;
...
pub(super) const USER_STREAM_READ: u8 = 0x90;
