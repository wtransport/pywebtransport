...
USER_CREATE_SESSION_OPTIMISTIC: Final[int] = 0x85
USER_CREATE_STREAM: Final[int] = 0x86
USER_EXPORT_KEYING_MATERIAL: Final[int] = 0x87
USER_GET_CONNECTION_DIAGNOSTICS: Final[int] = 0x88
USER_GET_SESSION_DIAGNOSTICS: Final[int] = 0x89
USER_GET_STREAM_DIAGNOSTICS: Final[int] = 0x8A
USER_READ_STREAM: Final[int] = 0x8B
USER_REJECT_SESSION: Final[int] = 0x8C
USER_RESET_STREAM: Final[int] = 0x8D
USER_SEND_DATAGRAM: Final[int] = 0x8E
USER_SEND_STREAM_DATA: Final[int] = 0x8F
USER_STOP_SENDING: Final[int] = 0x90
